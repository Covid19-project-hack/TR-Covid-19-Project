package com.trcovid19project.Models;

public class Jsons {

    String videos, home_treatment_images, home_treatment_links, toll_numbers, lab_test, donate,
            tweets, faq, epass, tracker, migrant, corona, cbse, vocational_education, go, health_care;

    public Jsons() {
    }

    public Jsons(String videos, String home_treatment_images, String home_treatment_links, String toll_numbers, String lab_test, String donate, String tweets, String faq, String epass, String tracker, String migrant, String corona, String cbse, String vocational_education, String go, String health_care) {
        this.videos = videos;
