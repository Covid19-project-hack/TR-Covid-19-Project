...
import com.trcovid19project.Adapter.CoronaAdapter;
import com.trcovid19project.Adapter.FAQAdapter;
import com.trcovid19project.Models.Corona;
import com.trcovid19project.Models.FAQ;
import com.trcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Tripura").getJSONObject("districtData");
